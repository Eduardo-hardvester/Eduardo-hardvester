            ...
            <div className="flex flex-1 justify-end md:justify-center">
              ...
              <nav className="pointer-events-auto hidden md:block">
                <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
                  <lin>
                    <Link  to="/acerca" className={`relative block px-3 py-2 transition  ${location.pathname === "/acerca" ? "text-teal-500 dark:text-teal-400 after:content-[''] after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-1 after:h-0.5 after:w-6 after:rounded-full after:bg-teal-500 dark:after:bg-teal-400" : "hover:text-teal-500 dark:hover:text-teal-400" }`}>Acerca</Link>
                 </lin>
                  <li>
                  <Link  to="/articulos" className={`relative block px-3 py-2 transition  ${location.pathname === "/articulos" ? "text-teal-500 dark:text-teal-400 after:content-[''] after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-1 after:h-0.5 after:w-6 after:rounded-full after:bg-teal-500 dark:after:bg-teal-400" : "hover:text-teal-500 dark:hover:text-teal-400" }`}>Articulos</Link>
                  </li>
                  <li>
